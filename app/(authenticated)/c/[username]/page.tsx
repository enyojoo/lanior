...
export default function CoachProfilePage() {
  ...
  // Mock coach data based on username
  const getCoachData = (username: string) => {
    const coaches = {
      "michael-nadezhda": {
        name: "Michael & Nadezhda",
        username: "michael-nadezhda",
        bio: "Licensed Marriage & Family Therapists | Helping couples build stronger connections | 15+ years experience | Authors of 'The Connection Code'",
        avatar:
        ...
        website: "https://michaelnadezhda.com",
        ...
        rating: 4.9,
        reviewCount: 1247,
        specialties: ["Couple Therapy", "Communication", "Trust Building", "Conflict Resolution"],
      ...
      "anna-hovsepyan": {
        ...
        rating: 4.8,
        reviewCount: 892,
        specialties: ["Relationship Coach", "Communication", "Dating", "Self-Love"],
        credentials: ["Licensed MFT", "MA Psychology", "Certified Coach"],
      },
      "sergey-ovsipenko": {
        ...
        website: "https://sergeyovsipenko.com",
        ...
        rating: 4.7,
        reviewCount: 634,
        specialties: ["Family Counseling", "Adolescent Therapy", "Parenting", "Family Dynamics"],
        credentials: ["Licensed LMFT", "MS Family Therapy", "Teen Specialist"],
      },
    }

    return coaches[username as keyof typeof coaches] || coaches["anna-hovsepyan"]
  }

  const coach = getCoachData(username)
      ...
      comments: [
        {
          ...
          content: "This workshop changed our relationship! Thank you!",
          time: "1 day ago",
        },
      ],
      time: "2 days ago",
