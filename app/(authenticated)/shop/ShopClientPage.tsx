...
import { Search, Heart, ShoppingCart, Filter, History, Star } from "lucide-react"
...
const products = [
  ...
  {
    id: 16,
    name: "Couples Communication Cards",
    description: "52 conversation starter cards designed to deepen intimacy and understanding between partners.",
    price: 29.99,
    originalPrice: 39.99,
    rating: 4.8,
    reviews: 124,
  ...
  {
    id: 17,
    name: "The Love Languages Book",
    description: "Discover your partner's love language and transform your relationship with this bestselling guide.",
    price: 16.99,
    originalPrice: null,
    rating: 4.9,
    reviews: 2847,
  ...
  {
    id: 18,
    name: "Relationship Journal Set",
    description: "His & hers journals with guided prompts for reflection, gratitude, and goal setting as a couple.",
    price: 34.99,
    originalPrice: 44.99,
    rating: 4.7,
    reviews: 89,
  ...
  {
    id: 19,
    name: "Date Night Ideas Box",
    description: "100 creative date night ideas to keep the spark alive in your relationship.",
    price: 24.99,
    originalPrice: null,
    rating: 4.6,
    reviews: 156,
  ...
  {
    id: 20,
    name: "Mindful Relationships Course",
    description: "Online course teaching mindfulness techniques for better relationship awareness and connection.",
    price: 89.99,
  ...
  {
    id: 21,
    name: "Couples Meditation App",
    description: "12-month subscription to guided meditations designed specifically for couples.",
    price: 59.99,
    originalPrice: 79.99,
    rating: 4.5,
    reviews: 78,
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <Sheet open={isFilterOpen} onOpenChange={setIsFilterOpen}>
          <SheetTrigger asChild>
            <Button variant="outline" className="sm:w-auto w-full flex items-center gap-2 bg-transparent">
    ...
    <Card className="overflow-hidden flex flex-col h-full group hover:shadow-lg transition-shadow">
      <CardHeader className="p-0 relative">
        <div className="relative aspect-square w-full overflow-hidden">
          ...
          {product.isNew && (
            <Badge variant="secondary" className="bg-green-500 text-white absolute top-2 left-2">
              New
            </Badge>
          )}
          {product.isBestseller && (
            <Badge variant="secondary" className="bg-orange-500 text-white absolute top-2 left-10">
              Bestseller
            </Badge>
          )}
        </div>
      ...
      <CardFooter className="p-4 pt-0 flex gap-2">
        <Button className="w-full" disabled={!product.inStock || isInCart} onClick={onAddToCart}>
