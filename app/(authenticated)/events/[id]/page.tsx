  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2">
        <Button variant="ghost" size="icon" onClick={() => router.push("/events")} className="h-8 w-8">
          <ArrowLeft className="h-4 w-4" />
        </Button>
        <h1 className="text-2xl font-bold unbounded">Event Details</h1>
      </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <span className="text-sm text-muted-foreground">{event.host.title}</span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="whitespace-pre-line text-muted-foreground">{event.description}</div>
            </div>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-6 bg-card rounded-lg border p-6 space-y-6">
            <div className="space-y-2">
              <h2 className="text-2xl font-bold">{event.price > 0 ? `$${event.price.toFixed(2)}` : "Free"}</h2>
            ...
            <div className="space-y-4">
              <Button
                ...
                disabled={isEventPast || isFull}
                onClick={() => setIsDialogOpen(true)}
              >
                {isEventPast ? "Event Ended" : isFull ? "Fully Booked" : "Register Now"}
              </Button>

              <Button variant="outline" className="w-full h-11 text-base" onClick={handleCopyLink}>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>You're registering for "{event.title}"</DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="text-xs text-muted-foreground">{format(new Date(event.date), "h:mm a")}</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              {event.location.type === "online" ? (
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">{event.location.platform}</span>
            ...
            <div>
              ...
              <span className="text-lg font-semibold">{event.price > 0 ? `$${event.price.toFixed(2)}` : "Free"}</span>
            </div>
          </div>
