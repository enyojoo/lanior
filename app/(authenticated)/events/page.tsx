...
export default function EventsPage() {
  ...
  const filteredEvents = events.filter((event) => {
    ...
    if (filter === "online") return matchesSearch && event.location.type === "online"
    if (filter === "offline") return matchesSearch && event.location.type === "offline"
    if (filter === "free") return matchesSearch && event.price === 0
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold unbounded">Events</h1>
        ...
        {filteredEvents.length > 0 ? (
          ...
          <div className="col-span-full text-center py-12">
            ...
            <p className="text-muted-foreground">
              {searchQuery ? "Try adjusting your search or filters" : "There are no upcoming events at this time"}
            </p>
          </div>
        )}
      </div>
