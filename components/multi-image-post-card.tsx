...
import { Heart, MessageCircle, Send, Check, Bookmark, Eye } from "lucide-react"
...
export interface MultiImagePostCardProps {
  user: User
  content: string
  images: string[]
  likes: string
...
export function MultiImagePostCard({ user, content, images, likes, comments, time, views }: MultiImagePostCardProps) {
  ...
  return (
    <Card className="overflow-hidden border border-border">
      ...
      <CardContent className="p-0">
        {/* Use the PostImageGrid component with limited images */}
        <div className="w-full" style={{ aspectRatio: "16/9" }}>
          <PostImageGrid images={limitedImages} alt={`${user.name}'s post`} />
        </div>
